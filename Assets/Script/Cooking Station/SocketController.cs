...
            else if (obj.TryGetComponent(out Food food))
        ...
        {
            // Jika benda yang keluar punya IngredientPasser, putus hubungannya
            if (args.interactableObject.transform.TryGetComponent(out IngredientPasser.IngredientPasser passer))
            {
                passer.ClearStation();
            }
