...
namespace CookOrPanic.MeshSlicer
{
    ...
    private Mesh _positiveSideMesh;
        ...
        public MeshSlicer(Plane plane, Mesh mesh, bool isSolid, bool createReverseTriangleWindings, bool shareVertices, bool smoothVertices)
        {
