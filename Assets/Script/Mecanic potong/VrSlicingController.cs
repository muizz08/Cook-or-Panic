...
namespace CookOrPanic.VrSlicingController
{
    using CookOrPanic.GeneratedMesh;
    public class VrSlicingController : MonoBehaviour
    {
        ...
        private void OnTriggerExit(Collider other)
        {
            ...
            GameObject[] slices = GeneratedMesh.Slice(plane, other.gameObject);
